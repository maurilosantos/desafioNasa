...
function Voltar_a_escolha_dos_Exoplanetas() {
  return (
    <>
        ...
        <Typewriter
          text="We've arrived! just updated my database with NASA's database, but we still have a lot of information to gather here. I've selected a few planets for us to visit today.
